...
const CompletionStatus = ({ task }) => (
  <div className="mb-6">
    <h2 className="text-xl font-semibold text-white mb-3">Status Penyelesaian</h2>
    <div className="bg-gray-700/30 border border-gray-600 rounded-xl p-4 md:p-5">
      <div className="flex flex-col sm:flex-row sm:items-center mb-3">
        <div className="flex items-center mb-2 sm:mb-0">
          <div className={`w-3 h-3 rounded-full mr-2 ${task.tanggalSelesai ? "bg-green-500" : "bg-red-500"}`}></div>
