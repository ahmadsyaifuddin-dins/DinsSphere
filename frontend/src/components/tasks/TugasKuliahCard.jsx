...
const TugasKuliahCard = ({ task, onViewDetail, onEdit, onDelete }) => {
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mt-6 gap-2">
          <button
            ...
            className="grow flex items-center justify-center gap-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-all duration-300 shadow-lg shadow-blue-900/20"
          >
          ...
          <button
            onClick={() => onEdit(task)}
            className="flex items-center justify-center p-2 bg-transparent hover:bg-gray-700 text-yellow-500 rounded-lg transition-all duration-300"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
          ...
          <button
            ...
            className="flex items-center justify-center p-2 bg-transparent hover:bg-gray-700 text-red-500 rounded-lg transition-all duration-300"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
