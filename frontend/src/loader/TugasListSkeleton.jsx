...
const TugasListSkeleton = () => {
  return (
    <div className="overflow-x-auto relative shadow-md sm:rounded-lg">
      <table className="w-full text-xs sm:text-sm text-left text-gray-300">
        <thead className="text-xs uppercase bg-gray-700 text-gray-300">
          <tr>
            <th scope="col" className="py-2 px-3 sm:py-3 sm:px-6">Nama Tugas</th>
            <th scope="col" className="py-2 px-3 sm:py-3 sm:px-6">Kesulitan</th>
            <th scope="col" className="py-2 px-2 sm:py-3 sm:px-6">Status</th>
            <th scope="col" className="py-2 px-3 sm:py-3 sm:px-6 md:table-cell">Deadline</th>
...
export default TugasListSkeleton;