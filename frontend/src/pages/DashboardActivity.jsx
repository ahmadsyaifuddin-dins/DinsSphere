      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8 border-b border-gray-700 pb-4">
          <div className="flex items-center">
            <FontAwesomeIcon icon={faHistory} className="text-blue-400 text-3xl mr-4" />
        ...
        {isLoading ? (
          ...
          <div className="bg-gray-800 rounded-lg p-8 text-center border border-gray-700">
            ...
            <p className="text-xl text-gray-300">No activities found in the system.</p>
            <p className="text-gray-400 mt-2">Activities will appear here once users start interacting with the system.</p>
          </div>
        ) : (
                    ...
                    <td className="py-3 px-4 whitespace-nowrap">
                      {activity.userId && activity.userId.name ? (
                        ...
                        >
                          ...
                          <span className="hover:underline">{activity.userId.name}</span>
                        </Link>
                      ) : (
